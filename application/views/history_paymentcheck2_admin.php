      ...
      <div class="card">
        ...
        <table class="table">
          ...
          <?php foreach ($query as $item) { ?>
            <?php if ($item->status == 'รอตรวจสอบการชำระเงินงวดที่2') { ?>
              <tbody>
                <tr>
                  ...
                  <td id="center">
                    <form action="<?php echo site_url('Payment_Controller/showpayment2_admin') ?>" method="POST">
