    ...
    <div class="row">
        ...
        <div class="col-6">
            <center>
                ...
                <a href="<?php echo $item->cus_fbprofile ?>" class="btn btn-secondary">ฉันต้องการส่งผ่าน Facebook</a>
                ...
                <form action="<?php echo site_url('Contract_Controller/upload_file3') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="inputfield">
                        <input id="text-lastname" type="file" class="input" name="img3">
                    </div>
                    <br>
                    <center>
                        ...
                        <a href="<?php echo site_url('Contract_Controller/history_submitwork_ptg') ?>" type="button" class="btn btn-secondary">ย้อนกลับ</a>
                        <!-- Modal -->
