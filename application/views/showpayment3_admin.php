        ...
        <div class="container">
            ...
            <center>
                <div class="alert alert-dark" role="alert">
                    รายละเอียดการตรวจสอบการชำระเงินงวดที่3
                </div>
            </center>
            <br>
            <div class="row">
                ...
                <div class="col-5">
                    <center>
                        ...
                        <img src="<?php echo base_url('img'); ?>/<?php echo $item->img4 ?>" width="400">
                    </center>
                </div>
                <div class="col-5">
                    ...
                    <center>
                        <form action="<?php echo site_url('Contract_Controller/success_payment') ?>" method="POST">
                            ...
                            <input type="text" name="status" value="ชำระเงินงวดที่3แล้ว" hidden>
                            <br>
