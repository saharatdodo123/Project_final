      ...
      <div class="card">
        ...
        <table class="table">
          ...
          <?php foreach ($query as $item) { ?>
            <?php if ($item->status == 'รอตรวจสอบการชำระเงินงวดที่3') { ?>
              <tbody>
                <tr>
                  ...
                  <td id="center">
                    <form action="<?php echo site_url('Payment_Controller/showpayment3_admin') ?>" method="POST">
