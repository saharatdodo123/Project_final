    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <a href="<?php echo site_url('Customer_Controller/givecreditmark_cus') ?>" style="width:200px;height:40px;" type="button" class="btn btn-info">ให้คะแนนช่างภาพ</a>
                    <a href="<?php echo site_url('Customer_Controller/check_history_cus') ?>" style="width:200px;height:40px;" type="button" class="btn btn-info">ประวัติการดำเนินการ</a>
                </div>
    ...
    <div class="card">
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php foreach ($query as $item) { ?>
                        <?php if ($item->status == 'รอการชำระเงินงวดที่2') { ?>
                            <tr>
                                ...
                                <td id="center">
                                    <form action="history_payment2_cus" method="POST">
