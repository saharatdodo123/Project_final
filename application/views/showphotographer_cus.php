        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card-body">
              <div class="d-flex flex-column align-items-center text-center">
                ...
                <div class="mt-3">
                  ...
                  <p class="text-secondary mb-1">ความถนัด</p>
                  <hr>
                  ...
                  <form action="<?= site_url('Contract_Controller/contract'); ?>" method="POST">
                    <input class="btn btn-primary" type="text" name="ptg_id" value="<?php echo $item->ptg_id ?>" hidden>
                    <input class="btn btn-primary" type="submit" value="ร่างสัญญา">
          ...
          <div class="card mt-3">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                <h6 class="mb-0"><svg viewBox="0 -61 512 512" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
  ...
  <div class="row">
    <?php foreach ($query2 as $item2) { ?>
      <div class="card" id="card" style="width: 20rem;">
        <img id="img" src="<?= base_url('img/' . $item2->img) ?>" width="720" height="460" class="card-img-top" alt="...">
        <div class="card-body">
